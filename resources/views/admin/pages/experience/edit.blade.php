...
@section('content')
    @php
        ...
        {
            return '<button type="submit" class="btn btn-sm btn-warning"><i class="material-icons">save</i></button>';
        });
    @endphp
    <x-admin-page-header title="ویرایش تجربه های کاری">
        <li class="breadcrumb-item"><a href="{{route('admin.experience.index')}}">برگشت</a></li>
    </x-admin-page-header>
    <div class="row my-4">
        <div class="col-sm my-1">
            <div class="bg-white rounded shadow-sm p-3">
                {!! Form::model($exp,['id'=>'expInsertForm','method'=>'PUT','route'=>['admin.experience.update',$exp->id]]) !!}
                    <div class="title mx-1 my-1 position-relative">
                        <h6>
                            ویرایش تجربه کاری فعلی
                        </h6>
                    ...
                    <div class="form-content">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col">
                                    {!! Form::label('role','سمت') !!}
                                    {!! Form::text('role',null,['id'=>'role','class'=>'form-control form-control-sm '.($errors->has('role')? 'is-invalid':''),'placeholder'=>'مثال: برنامه نویس بک اند']) !!}
                                    @error('role')
